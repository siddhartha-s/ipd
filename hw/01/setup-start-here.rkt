...
3) Choose the "File | Install .plt file..." menu item.

   Click "Web" in the top of the resulting dialog and
   paste this into the dialog:

http://users.eecs.northwestern.edu/~jesse/course/eecs495ipd-fa16/nwu-ipd-2016.plt
...
6) Each file you complete is handed in separately. When you
   finish one, click that new button (the one ignored in
   step 4) and make sure you submit it to the right assignment.
   Submit one to each.

7) check on the status of your submissions here:
