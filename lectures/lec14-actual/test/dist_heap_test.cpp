...
TEST(Insert5Remove5)
{
    ...
    CHECK_EQUAL(0, heap.remove_min().w);
    CHECK_EQUAL(2, heap.remove_min().w);
    CHECK_EQUAL(4, heap.remove_min().w);
    CHECK_EQUAL(6, heap.remove_min().w);
    CHECK_EQUAL(8, heap.remove_min().w);
...
SSSP_result dijkstraH(const WU_graph& graph,
...
TEST(Dijkstra)
{
    ...
    SSSP_result result = dijkstraH(g, 1);
