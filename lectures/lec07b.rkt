...
function. (AKA: always follow the template.)
...
Generative recursion in the design recipe:

  - generative recursion is a new strategy; it means the
    function is recursive, but the recursion does not come
    from the template
